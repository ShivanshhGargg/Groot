# Kairos Web/PWA Frontend Scope

This Flutter frontend is based on the attached Kairos plan, with the launch order adjusted for web app and PWA feedback before App Store / Play Store release.
...
- Manager Inbox: text intake, upload hooks, voice upload hook, Kairos Inbox address, needs-review queue
...
Until those endpoints are implemented, `lib/shared/data/Kairos_repository.dart` provides demo state so users can click through the app and give product feedback.
