...
class GrootNotification {
  const GrootNotification({
    required this.id,
    required this.title,
    required this.body,
    required this.type,
  ...
  GrootNotification copyWith({bool? read}) {
    return GrootNotification(
      id: id,
      title: title,
      body: body,
      type: type,
...
class UserProfile {
  const UserProfile({
    ...
    required this.grootInboxAddress,
  ...
  final String grootInboxAddress;
  ...
  UserProfile copyWith({
    ...
    return UserProfile(
      ...
      grootInboxAddress: grootInboxAddress,
