...
class _WorkflowStatus extends ConsumerWidget {
  ...
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final workflow = ref.watch(grootRepositoryProvider).workflowById(id)!;
    return GrootCard(
      ...
      child: Column(
        ...
        children: [
          ...
          LinearProgressIndicator(
            ...
            color: workflow.snoozesUsed >= 3 ? GrootColors.critical : stateColor,
            backgroundColor: stateColor.withOpacity(0.12),
            minHeight: 8,
            borderRadius: BorderRadius.circular(GrootRadius.sm),
          ),
          const SizedBox(height: GrootSpacing.sm),
          ...
          Wrap(
            ...
            children: [
              ElevatedButton.icon(
                ...
                onPressed: () {
                  ref.read(grootRepositoryProvider.notifier).resolveWorkflow(id);
                },
              ),
              OutlinedButton.icon(
                ...
                onPressed: workflow.snoozesUsed >= 3
                    ? null
                    : () {
                        ref.read(grootRepositoryProvider.notifier).snoozeWorkflow(id);
                      },
              ),
              OutlinedButton.icon(
...
class _StepRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final color = step.complete ? GrootColors.success : Theme.of(context).disabledColor;
    return Row(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Column(
        ...
        Expanded(
          child: Padding(
            padding: const EdgeInsets.only(bottom: GrootSpacing.lg),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
