          ...
          child: Column(
            ...
            children: [
              ...
              for (final entry in memory.metadata.entries) ...[
                ...
                const Divider(height: GrootSpacing.lg),
              ],
              ...
              Wrap(
                ...
                children: [
                  ElevatedButton.icon(
                    ...
                    onPressed: () {
                      ref.read(grootRepositoryProvider.notifier).confirmMemory(memory.id);
                    },
                  ),
                  OutlinedButton.icon(
...
class _TimelinePanel extends ConsumerWidget {
  ...
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final memory = ref.watch(grootRepositoryProvider).memoryById(memoryId)!;
    return Column(
      crossAxisAlignment: CrossAxisAlignment.stretch,
      children: [
...
class _TimelineEntry extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final color = complete ? GrootColors.success : Theme.of(context).disabledColor;
    return Padding(
