...
class _MemoriesScreenState extends ConsumerState<MemoriesScreen> {
  ...
  Widget build(BuildContext context) {
    final memories = ref.watch(grootRepositoryProvider).memories.where((memory) {
    ...
    return PageScaffold(
      title: 'Memories',
      subtitle: 'Search, confirm, and correct what Groot remembers.',
      actions: [
        ElevatedButton.icon(
        ...
        children: [
          ...
          SingleChildScrollView(
            ...
            child: Row(
              children: [
                Padding(
                  padding: const EdgeInsets.only(right: GrootSpacing.sm),
                  child: FilterChip(
          ...
          if (memories.isEmpty)
            const GrootCard(child: Text('No memories yet.'))
          else
            LayoutBuilder(
              builder: (context, constraints) {
                ...
                return GridView.builder(
                  ...
                  gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                    ...
                    crossAxisSpacing: GrootSpacing.md,
                    mainAxisSpacing: GrootSpacing.md,
