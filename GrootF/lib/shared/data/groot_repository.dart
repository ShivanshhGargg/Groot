...
final grootRepositoryProvider =
    StateNotifierProvider<GrootRepository, GrootData>((ref) {
  return GrootRepository();
});
...
class GrootData {
  ...
  final List<GrootNotification> notifications;
  ...
  GrootData copyWith({
    ...
    List<GrootNotification>? notifications,
...
class GrootRepository extends StateNotifier<GrootData> {
  GrootRepository() : super(_seedData);
...
const _seedData = GrootData(
  ...
  workflows: [
    ...
    Workflow(
      ...
      steps: [
        WorkflowStep(
          label: 'Detected',
          description: 'Flight ticket parsed from Groot Inbox.',
          complete: true,
        ),
        WorkflowStep(
          label: 'Prepare',
  ...
  profile: UserProfile(
    ...
    occupation: 'Student',
    grootInboxAddress: 'groot+shivansh@groot.ai',
