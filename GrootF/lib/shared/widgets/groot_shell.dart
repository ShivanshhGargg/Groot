...
import '../data/groot_repository.dart';

class GrootShell extends ConsumerWidget {
  const GrootShell({required this.child, super.key});
          ...
          NavigationRail(
            ...
            trailing: Expanded(
              child: Align(
                ...
                child: Padding(
                  padding: const EdgeInsets.only(bottom: GrootSpacing.md),
                  child: Column(
