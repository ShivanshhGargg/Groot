...
class GrootTheme {
  ...
  static ThemeData light() {
    return _base(
      ...
      primary: GrootColors.primary,
      surface: Colors.white,
      scaffold: const Color(0xFFF8FAFC),
      textPrimary: GrootColors.textPrimary,
      textSecondary: GrootColors.textSecondary,
      border: GrootColors.border,
    );
  }
  ...
  static ThemeData dark() {
    return _base(
      ...
      primary: GrootColors.primaryDark,
      surface: GrootColors.darkSurface,
      scaffold: const Color(0xFF0B1120),
      textPrimary: GrootColors.surface,
      textSecondary: const Color(0xFFCBD5E1),
      border: GrootColors.darkBorder,
    );
  }
